...
Sub main()
  ...
  sAryEnum = Array(Array("modAry.bas", 5, 9),Array("modUtil.bas", 5, 10),Array("modRng.bas", 5, 9))
  sAryProc = Array(Array("modAry.bas", 10, -1), Array("modFnc.bas", 5, -1), Array("modUtil.bas", 11, -1),Array("modRng.bas", 10, -1), Array("modLog.bas", 5, 29))
